package lando.systems.ld58.utils.aseprite;
...
public class Aseprite {
    ...
    public enum Modes {
        ...
        public static Modes fromValue(int value) {
            if (value == 1) return indexed;
            else if (value == 2) return grayscale;
            else if (value == 4) return rgba;
            else throw new GdxRuntimeException("Invalid Aseprite.Modes value: " + value);
        }
    }
        ...
        public static Chunks fromValue(int value) {
            switch (value) {
                ...
                case 0x2022:
                    return Slice;
                default:
                    throw new GdxRuntimeException("Invalid Aseprite.Chunks value: " + value);
            }
        }
    }
        ...
        public static LoopDirections fromValue(int value) {
            switch (value) {
                ...
                case 2:
                    return PingPong;
                default:
                    throw new GdxRuntimeException("Invalid Aseprite.LoopDirections value: " + value);
            }
        }
    }
        ...
        public static LayerTypes fromValue(int value) {
            switch (value) {
                ...
                case 1:
                    return Group;
                default:
                    throw new GdxRuntimeException("Invalid Aseprite.LayerTypes value: " + value);
            }
        }
    }
    ...
    public static SpriteInfo loadAndPack(PixmapPacker packer, String path) {
        ...
        if (!aseprite.slices.isEmpty() && aseprite.slices.get(0).has_pivot) {
            var slice = aseprite.slices.get(0);
        ...
        for (var anim_tag : aseprite.tags) {
            ...
            for (int i = 0; i < num_frames; i++) {
                ...
                var frame_region_name_w_index = Stringf.format("%s_%d", frame_region_name, i);
